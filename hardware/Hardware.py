...
from bt_poller.Bt_poller import BtPoller
from bt_poller.Bt_poller import MI_TEMPERATURE, MI_HUMIDITY, MI_BATTERY
...
class Hardware(object):
    ...
    def update_device_info(self, device: Device):
        poller = BtPoller(device.mac, BluepyBackend, ble_timeout=self._timeout)
        try:
